  ...
  <section id="sobre-historia" class="bg-background-surface py-20">
    <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
      ...
      <div class="space-y-4 text-base leading-relaxed text-foreground/70">
        ...
        <p>
          Cada lote passa por controle rigoroso de qualidade antes de sair da fábrica,
          garantindo sabor consistente, textura ideal e apresentação impecável em todos
          os pedidos.
        </p>
        <p>
